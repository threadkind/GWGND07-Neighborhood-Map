...
const flickrIcon = require("./imgs/foursquare.png");
const foursquareIcon = require("./imgs/flickr.png");
		...
		>X</div>
		  ...
		  <div id="info-menu">
			...
			<div className="icon-contain">
			  <img className="sm-icons flIcon hidden"
			  		src={ flickrIcon }
			  		alt="flickr icon"
			  />
			  <img className="sm-icons fsIcon hidden"
			  		src={ foursquareIcon }
			  		alt="foursquare icon" />
			</div>
			...
			<div className="tab-content tab3"
				  ...
				  aria-label="photos from location"
			>
			  <div className="flickr-error hidden">Unable to load images from Flickr
			  </div>
		  ...
		  <div className="photo-overlay hidden" onClick={ this.closePhotoOverlay }>
			<div className="photo-overlay-image-contain" onClick={ this.closePhotoOverlay } >
			  <div className="photo-overlay-close" onClick={ this.closePhotoOverlay }
			  >X</div>

			  <img className="big-photo"
			  		src={this.state.bigImage}
			  		alt="large version in overlay"
			  		onClick={ this.closePhotoOverlay }
			  />
			</div>
		  </div>
